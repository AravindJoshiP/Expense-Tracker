//
//  allExpenseTableViewController.swift
//  Expense Tracker
//
...
class allExpenseTableViewController: UITableViewController {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let AddExpViewController = segue.destination as? AddExpViewController{
            if let indexPath = self.tableView.indexPathForSelectedRow{
                AddExpViewController.expense = expenses[indexPath.row]
            }
        }
    }
